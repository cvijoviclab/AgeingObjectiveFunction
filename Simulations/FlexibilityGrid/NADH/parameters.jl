...
const firstObjective = ["NADHProduction" for i = 1:6]
const firstSense = [MOI.MIN_SENSE for i = 1:6]
const firstFlexibility = collect(0.05:0.05:0.5)

# set the second FBA objective
const secondObjective = ["", "growth", "glucoseUptake", "ATPProduction", "ATPProduction", "NGAM"]
const secondSense = [MOI.MAX_SENSE, MOI.MAX_SENSE, MOI.MIN_SENSE, MOI.MIN_SENSE, 
                     MOI.MAX_SENSE, MOI.MAX_SENSE]
