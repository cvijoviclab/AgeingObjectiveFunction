...
const firstObjective = ["NGAM" for i = 1:6]
const firstSense = [MOI.MAX_SENSE for i = 1:6]
const firstFlexibility = collect(0.05:0.05:0.5)

# set the second FBA objective
const secondObjective = ["", "growth", "glucoseUptake", "ATPProduction", "ATPProduction", "NADHProduction"]
const secondSense = [MOI.MAX_SENSE, MOI.MAX_SENSE, MOI.MIN_SENSE, MOI.MAX_SENSE, 
                     MOI.MIN_SENSE, MOI.MIN_SENSE]
