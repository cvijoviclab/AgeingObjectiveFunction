...
const firstObjective = ["growth", "growth", "growth", "growth", 
                        "growth", "growth", "ATPProduction"]
const firstSense = [MOI.MAX_SENSE for i = 1:7]
const firstFlexibility = collect(0.3:0.05:0.5)

# set the second FBA objective
const secondObjective = ["", "glucoseUptake", "ATPProduction", "ATPProduction", 
                         "NADHProduction", "NGAM", "growth"]
const secondSense = [MOI.MAX_SENSE, MOI.MIN_SENSE, MOI.MIN_SENSE, MOI.MAX_SENSE, 
                     MOI.MIN_SENSE, MOI.MAX_SENSE, MOI.MAX_SENSE]
const secondFlexibility = collect(0.05:0.05:0.2)
const parsimonious = [false, true]
